...
export default function AccountDropdown() {
  ...
  const { user_name, email, avatar } = useUserInfo();
  ...
  const items: MenuProps['items'] = [
    ...
    {
      label: <NavLink to="/admin-info/profile">{t('sys.menu.user.profile')}</NavLink>,
      key: '2',
    },
    {
      label: <NavLink to="/admin-info/account">{t('sys.menu.user.account')}</NavLink>,
      key: '3',
    },
    { type: 'divider' },
    {
