module.exports = {
  root: true,
  // Indicates that the current directory is the root directory, and ESLint rules will be restricted to this directory.
  ...
  rules: {
    ...
    // No need to introduce react manually
    ...
    'import/order': [
      'warn',
      {
        ...
        'newlines-between': 'always', // Insert empty rows between groups
